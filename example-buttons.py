...
# Mapping of color names to hex literal and a fact about the
# color itself.
COLORS: typing.Mapping[str, typing.Tuple[int, str]]  = {
    ...
    "White": (
        0xFFFFFF,
        "White objects fully reflect and scatter all visible wavelengths of light!"
    ),
}
...
class Rgb(lightbulb.slash_commands.SlashCommand):
    ...
    # Pass a list of guild id's here for testing, but remove them to
